...
SELECT posix_account.id, 
posix_account.uidnumber, 
posix_account.uid,
posix_account.gidnumber, 
posix_account.firstname,
posix_account.surname, 
posix_account.homedirectory,
posix_account.gecos, 
posix_account.loginshell,
posix_account.userpassword, 
posix_account.description,
samba_sam_account.sambasid, 
samba_sam_account.cn,
samba_sam_account.sambalmpassword,
samba_sam_account.sambantpassword,
samba_sam_account.sambapwdlastset, 
samba_sam_account.sambalogontime,
...
samba_sam_account.sambaacctflags, 
samba_sam_account.displayname,
samba_sam_account.sambahomepath, 
samba_sam_account.sambahomedrive,
...
posix_account_details.schoolnumber, 
posix_account_details.unid,
posix_account_details.exitunid, 
posix_account_details.birthname,
posix_account_details.title, 
posix_account_details.gender,
posix_account_details.birthday,
posix_account_details.birthpostalcode,
posix_account_details.birthcity, 
posix_account_details.denomination,
posix_account_details."class", 
posix_account_details.adminclass,
posix_account_details.exitadminclass,
posix_account_details.subclass, 
posix_account_details.creationdate,
posix_account_details.tolerationdate,
posix_account_details.deactivationdate,
posix_account_details.sophomorixstatus,
posix_account_details.mymail,
posix_account_details.mylanguage,
posix_account_details.accountstatus, 
posix_account_details.quota,
posix_account_details.mailquota,
posix_account_details.firstpassword,
posix_account_details.internetstatus,
posix_account_details.emailstatus, 
posix_account_details.lastlogin,
posix_account_details.lastgid, 
posix_account_details.classentry,
...
posix_account_details.education, 
posix_account_details.occupation,
posix_account_details.starttraining,
posix_account_details.usertoken,
posix_account_details.scheduled_toleration,
posix_account_details.endtraining, 
groups.gid FROM (((posix_account
...
CREATE VIEW memberdata AS SELECT posix_account.uid, posix_account.uidnumber as uidnum, posix_account.gecos,(SELECT gid from groups where gidnumber=posix_account.gidnumber) as adminclass, posix_account_details.sophomorixstatus as s,groups.gid,groups.gidnumber as gidnum,project_details.longname FROM posix_account FULL JOIN posix_account_details on posix_account.id=posix_account_details.id LEFT OUTER JOIN groups_users on groups_users.memberuidnumber=posix_account.uidnumber LEFT OUTER JOIN groups on groups.gidnumber=groups_users.gidnumber LEFT OUTER JOIN project_details on project_details.id=groups.id ORDER by gid,uid;
...
INSERT INTO ldap_attr_mappings VALUES (15, 4, 'memberUid', 'posix_account.uid', NULL, 'posix_account,groups_users,groups', 'groups_users.memberuidnumber=posix_account.uidnumber AND groups_users.gidnumber=groups.gidnumber', '{ call set_account_memberuid(?,?) }', '{ call del_account_memberuid(?,?) }', 1, 0);
